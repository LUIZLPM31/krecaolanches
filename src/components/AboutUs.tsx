        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            <div className="relative">
              <img 
                alt="K-recão Lanches Fachada" 
                className="rounded-lg shadow-2xl w-full h-[400px] object-cover" 
                src="/lovable-uploads/fe07d8ff-5dc1-4036-9cd6-a5142018b96b.png" 
              />
              <div className="absolute -bottom-5 -right-5 bg-krecao-red p-4 rounded-lg shadow-lg">
                <p className="text-white font-bold text-lg">Desde 2010</p>
              </div>
            </div>
          </div>
          ...
          <div className="lg:w-1/2">
            ...
            <div className="flex items-center mb-6 bg-black/30 p-4 rounded-lg border-l-4 border-krecao-red">
              <div className="mr-4">
                <span className="text-krecao-yellow text-4xl font-bold">13+</span>
              </div>
              <p className="text-gray-300">
                <span className="font-semibold">Anos de experiência</span><br />
                Servindo lanches de qualidade
              </p>
            </div>
