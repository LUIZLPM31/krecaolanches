      ...
      <div className="container relative z-10 mx-auto px-6 py-32 md:py-0">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto animate-fade-in">
          <div className="mb-8 relative">
            <img src="/lovable-uploads/93e5cd42-eca6-41a9-92d5-35b49e1d113f.png" alt="K-recão Lanches Logo" className="h-32 md:h-40 relative" />
          </div>
          
          <h1 className="text-4xl md:text-6xl font-bold text-white leading-tight">
            <span className="text-krecao-yellow">O Melhor</span> lanche da <span className="text-krecao-red">zona sul</span>
          </h1>
